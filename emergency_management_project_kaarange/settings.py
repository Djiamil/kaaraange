"""
Django settings for emergency_management_project_kaarange project.
...
SECRET_KEY = 'django-insecure-3%ej-lkljxj)4rxr*ay0k6aug$=^3xe@fjw+yf_%+y0@s=hi_z'
...
WSGI_APPLICATION = 'emergency_management_project_kaarange.wsgi.application'
